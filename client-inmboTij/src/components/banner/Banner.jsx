        ...
        <div className='banner'>
            ...
            <div className='banner-tittle m-4 p-4 w-100  mx-auto'>
                <div className="m-4 p-sm-4 ">
                    <h1 className = "fw-bold h1-tittle">La agencia inmobiliaria en Tijuana mas confiable</h1>
                ...
                <div className="mx-4 px-4">
                    <button className="contact-button fw-bolder "> Contactanos <span style={{color:'white'}} className="mx-2"><FaArrowRightLong /></span></button>
                </div>
